...
-- Agendamentos
insert into agendamento (id, usuario_id, baia_id, inicio, fim, status, instrutor_id_aprovou, observacao, instrutor_notificado, usuario_notificado)
values 
(1, 1, 1, '2019-09-17 13:00:00.00', '2019-09-17 15:00:00.00', 'PENDENTE', null, null, false, false),
(2, 1, 7, '2019-12-31 19:00:00.00', '2019-12-31 23:59:59.99', 'APROVADO', 2, null, false, false),
(3, 1, 3, '2019-09-15 08:00:00.00', '2019-09-15 10:00:00.00', 'APROVADO', 2, null, false, false);

-- Solicitacoes conferencia
insert into solicitacao_conferencia (id, usuario_id, instrutor_id, baia_id, instrutor_notificado, status, data_solicitacao, data_resposta)
values
